...
write.csv(Shiller, "C:/Users/George Wu/Documents/Empirical-Finance_PhD_Assignment-1-main/spx_data.csv")
...
write.csv(data, "C:/Users/George Wu/Documents/Empirical-Finance_PhD_Assignment-1-main/industry_data.csv")